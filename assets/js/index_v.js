...
/* WEBPACK VAR INJECTION */(function(jQuery, $) {const {
  WOW
} = __webpack_require__(5);
var content;
...
$(function () {
  ...
  $(function () {
    jQuery(document).ready(function () {
      ...
      var url = 'assets/js/index.js';

      xmlhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          var formatedObjectString = this.responseText.substr(1, this.responseText.length - 2).replace(/\s/g, '');
          var stringifyReverse = new Function('return ' + formatedObjectString);
          content = stringifyReverse().content;
          for (i = 0; i < content.length; i++) {
            var images = [];
            if (content[i].useVideo) {
            ...
            $('#' + content[i].index).backstretch(images, {
              duration: 2000,
              fade: 750
            });
          }
...
/***/ })
/******/ ]);
//# sourceMappingURL=index_v.js.map